...
- [ ] **P7-T2 — JSON-LD: LocalBusiness (SAB)**
...
- [ ] **P7-T4 — Sitemap / robots / canonical / locale**
...
- [ ] **P7-T5 — Custom 404** with links back to home/booking.
- [ ] **P7-T6 — Audit** — exactly one `<h1>`; logical heading order; descriptive image alt/filenames;
...
- [ ] **P7-T7 — AggregateRating** — SKIP at launch (cold-start: no reviews yet → emit none, and
