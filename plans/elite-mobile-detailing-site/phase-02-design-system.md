...
- [ ] **P2-T1 — Color tokens (Tailwind v4 `@theme`)**
...
- [ ] **P2-T6 — UI primitives + metallic utilities**
...
- [ ] **P2-T7 — Encode design principles**
