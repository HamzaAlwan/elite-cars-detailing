...
- [ ] **P3-T2 — Hero (§4.2)**
  - `min-height:100svh` (not bare `100vh` — §2.5); headline + subheadline; COLD-START (no reviews
    ...
    GBP reviews exist.
- [ ] **P3-T3 — Value props (§4.3)** — 4 badge cards, grid 1→2→4; subtle hover micro-motion on each
  Lucide icon via `.icon-hover` (desktop pointer only, §2.3/§2.4).
- [ ] **P3-T4 — Pricing matrix shell (§4.4)**
...
- [ ] **P3-T5 — How It Works (§4.5)** — 3 steps; payment = card/contactless/Apple Pay (cash welcome).
- [ ] **P3-T6 — Social proof (§4.7)** — COLD-START: guarantee callout, insured/certified +
...
- [ ] **P3-T7 — Service area static (§4.8)** — coverage list + copy; container for the zip island (P4-T3).
- [ ] **P3-T8 — Footer (§4.12)** — columns (areas/contact/links/social/legal), NAP, click-to-call,
...
- [ ] **P3-T9 — Sticky mobile action bar (§3.2)** — fixed `[Book] [Call]`, mobile only; safe-area
