...
- [x] **P4-T1 — Mobile nav slide-over** (`client:idle`)
...
- [x] **P4-T2 — Pricing size-selector → instant estimator** (`client:visible`)
...
- [x] **P4-T3 — Zip-code validator** (`client:visible`)
