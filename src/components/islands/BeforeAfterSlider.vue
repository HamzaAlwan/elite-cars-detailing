...
<template>
  <figure class="overflow-hidden rounded-2xl">
    ...
    >
      <img slot="first" :src="props.before" :alt="props.beforeAlt" class="w-full" width="800" height="600" loading="lazy" />
      <img slot="second" :src="props.after" :alt="props.afterAlt" class="w-full" width="800" height="600" loading="lazy" />
      <!-- Custom handle -->
      <div
        slot="handle"
        ...
        aria-hidden="true"
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="text-brand" aria-hidden="true">
